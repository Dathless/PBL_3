...
export default function LoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Cập nhật context nếu dùng auth-context
      // login({ username, role });
  
      console.log("Login successful with user: " + username + " and role: " + role);
      ...
      const description = err.response?.data || "Check your credentials";
