...
export default function SignupSellerPage() {
    ...
    const handleSignup = async (e: React.FormEvent) => {
        ...
        try {
            const finalAddress = address ? `${address} | Business: ${businessName}, Tax ID: ${taxId}` : `Business: ${businessName}, Tax ID: ${taxId}`
            ...
            toast({
                ...
                description: `Your seller account has been created. Please login to continue.`,
            })
        ...
        <main className="min-h-screen bg-white">
            ...
            <div className="max-w-md mx-auto px-4 py-12">
                ...
                <div className="mb-8">
                    ...
                    <p className="text-gray-600">Register as a seller to start selling</p>
                </div>
