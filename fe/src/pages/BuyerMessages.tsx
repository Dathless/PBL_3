...
import { Search, Send, MessageSquare, User, Package, ChevronRight, Home } from 'lucide-react'
...
export default function BuyerMessages() {
    ...
    return (
        <div className="min-h-screen bg-gray-50 flex flex-col">
            <Header />
            <div className="flex-1 max-w-7xl w-full mx-auto px-4 py-8 flex overflow-hidden h-[calc(100vh-160px)]">
                <div className="flex w-full bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
                        ...
                        {selectedUserId && selectedConversation ? (
                            <>
                                ...
                                <div className="p-4 border-b border-gray-200 flex items-center justify-between bg-white shadow-sm z-10">
                                    ...
                                    {selectedConversation.productId && (
                                        <Link
                                            to={`/product/${selectedConversation.productId}`}
                                            className="hidden sm:flex items-center gap-2 border border-blue-100 bg-blue-50/50 rounded-lg px-3 py-1.5 hover:bg-blue-100 transition"
                                        >
                                            <Package className="w-4 h-4 text-blue-500" />
                                            <div className="text-left">
                                                <p className="text-[10px] text-blue-500 font-bold uppercase tracking-wider">Product</p>
                            ...
                            <div className="flex-1 flex flex-col items-center justify-center bg-gray-50/30">
                                <div className="bg-white p-10 rounded-3xl shadow-xl shadow-gray-100 flex flex-col items-center text-center max-w-sm">
                                    ...
                                    <h3 className="text-xl font-bold text-gray-900 mb-2">Message Center</h3>
                                    <p className="text-sm text-gray-500 mb-8">
                                        Chat with sellers to ask questions about products, shipping, or your orders.
                                    </p>
                                    <Link to="/" className="flex items-center gap-2 text-sm text-cyan-600 font-bold hover:gap-3 transition-all">
